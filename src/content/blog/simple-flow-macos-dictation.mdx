...
<LinkCard
	title="Wispr Flow"
	description="Blazing fast cloud-powered dictation with outstanding real-time recognition accuracy and audio cues."
...
<LinkCard
	title="MacWhisper"
	description="Popular native macOS dictation app running local OpenAI Whisper models directly on Apple Silicon."
