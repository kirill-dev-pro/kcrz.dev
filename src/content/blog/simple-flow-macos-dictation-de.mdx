...
### Prompt 1: Kernlogik und State Machine
...
Codex wählte die passenden macOS-Systemframeworks (`AVFoundation`, `ApplicationServices`, `CoreGraphics`) und baute eine saubere, deterministische State Machine:
